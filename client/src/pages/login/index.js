...
const Login = () => {
  ...
  return (
    <div
      className="flex flex-col justify-center content-center bg-cover bg-center h-screen backdrop-blur-sm"
      ...
      <div className="flex m-10 mb-4 	bg-center rounded-xl bg-tuna-900 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 border border-satinLinen-500">
            ...
            {({ errors, touched }) => (
              <Form className="m-16">
                ...
                {errors.password && touched.password ? (
                  <div className="text-satinLinen-700">{errors.password}</div>
                ) : null}
                <br />
                <br />
        ...
        <div className="text-center w-1/2 text-tuna-900">
          ...
          <p className="text-4xl m-4">
            Hey there! We're thrilled to have you back on our online cash app.
            Let's get started!
          </p>
